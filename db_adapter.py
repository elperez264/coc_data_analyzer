...
class DbManagement:
    ...
    def add_war_from_object(self, war: War) -> int:
        ...
        return self.db_adapter.add_war(clan_opponent_tag=opponent_tag, end_hour=end_hour, is_league=is_league,
                                       attacks_per_member=attacks_per_member, date=war.start_date)
